...
print "1..9\n";
cPanel::IO::Socket::SSL::context_init(SSL_verify_mode => 0x01, SSL_version => 'TLSv1' );
...
cPanel::IO::Socket::SSL::socketToSSL($contact, {
    SSL_server => 1,
    SSL_verify_mode => 0,
...
print "not " if cPanel::IO::Socket::SSL::socket_to_SSL($contact, SSL_server => 1);
...
sub bail {
    print "Bail Out! $cPanel::IO::Socket::SSL::ERROR";
}
