...
unless (fork) {
    ...
    $client = cPanel::IO::Socket::SSL->new(
	PeerAddr => $saddr,
...
#    }
    ...
    $client_2 = cPanel::IO::Socket::SSL->new_from_fd($client_2->fileno, '+<>',
    ...
    if ($CAN_NONBLOCK) {
	my $client_3 = cPanel::IO::Socket::SSL->new(
	    PeerAddr => $saddr,
	    SSL_verify_mode => 0x01,
	    SSL_version => 'TLSv1',
	    SSL_cipher_list => 'HIGH',
	...
	my $client_4 = cPanel::IO::Socket::SSL->new(
	    PeerAddr => $saddr,
