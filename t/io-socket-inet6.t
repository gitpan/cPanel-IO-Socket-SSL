...
# IO::Socket::INET6
if( cPanel::IO::Socket::SSL->CAN_IPV6 eq "IO::Socket::IP" ) {
    print "1..0 # Skipped: using IO::Socket::IP instead\n";
    exit;
}

# check if we have loaded INET6, cPanel::IO::Socket::SSL should do it by itself
# if it is available
unless( cPanel::IO::Socket::SSL->CAN_IPV6 eq "IO::Socket::INET6" ) {
