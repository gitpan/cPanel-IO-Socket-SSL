...
package cPanel::IO::Socket::SSL::Utils;
use strict;
use warnings;
use Carp 'croak';
use Net::SSLeay;
...
sub CERT_create {
	...
	organizationName => 'cPanel::IO::Socket::SSL',
	commonName => 'cPanel::IO::Socket::SSL Test'
    };
...
cPanel::IO::Socket::SSL::Utils -- loading, storing, creating certificates and keys
...
Default points to cPanel::IO::Socket::SSL.
