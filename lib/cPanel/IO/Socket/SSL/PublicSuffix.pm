...
use strict;
use warnings;
package cPanel::IO::Socket::SSL::PublicSuffix;
use Carp;
...
cPanel::IO::Socket::SSL::PublicSuffix - provide access to Mozillas list of effective TLD names

=head1 SYNOPSIS

    # use builtin default
    use cPanel::IO::Socket::SSL::PublicSuffix;
    $ps = cPanel::IO::Socket::SSL::PublicSuffix->default;

    # load from string
    $ps = cPanel::IO::Socket::SSL::PublicSuffix->from_string("*.uk\n*");

    # load from file or file handle
    $ps = cPanel::IO::Socket::SSL::PublicSuffix->from_file($filename);
    $ps = cPanel::IO::Socket::SSL::PublicSuffix->from_file(\*STDIN);
 ...
 ----
    ...
    perl -McPanel::IO::Socket::SSL::PublicSuffix -e 'cPanel::IO::Socket::SSL::PublicSuffix::update_self_from_url()'
...
=head1 BUGS
 ...
 A: Because the public suffix data change more often than these modules do,
    cPanel::IO::Socket::SSL needs this list and it is more easy this way to keep it
    up-to-date.
